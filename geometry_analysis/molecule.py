...
import numpy as np
# from .measure import * #calculate_distance, calcualte_angle
...
class Molecule:
    ...
    @coordinates.setter
    # the setter is used to set the coordinates() function.
    # because bonds is dependent on coordiantes, this is a reset bonds or other related properties due to the change of your coordinates.
    # in python, "_" in front of the variable like "_coordinates" means it is private, we don't want the users to change it.
...
if __name__ == "__main__":
    ...
    print(F'The coordinates is {my_molecule.coordinates}.')
